$(document).ready(function () {
  $(".footer").html(`
  <div class="d-flex pt-5 pb-5 row justify-content-around text-lg-center text-md-center">
  
    <div class="footer-content col-xl-3 col-lg-6 col-md-6 p-3">
    ...
    <div class="footer-content col-xl-3 col-lg-6 col-md-6 p-3">
      ...
      <p class="s-12 copyright">© Copyright 2022 - ZaraTherapyClinic</p>
