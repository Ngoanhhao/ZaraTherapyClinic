$(document).ready(function () {
  $(".footer").html(`
    <div class="d-flex pt-5 pb-5 row">
    <div class="col-3">
      ...
      <p class="s-12 mt-3">© Copyright 2022 - ZaraTherapyClinic</p>
    </div>
    ...
    <div class="footer-content col-3">
      <h3 class="mb-3">Userful Links</h3>
    ...
    <div class="col-3 s-14">
      <h3 class="mb-3">LOCATIONS</h3>
      <h4>ZaraTherapyClinic - Da Nang</h4>
      <p>36 Yen Bai - Da Nang</p>
      <p>Tel: <a href="tel:+0905622271">+0905 622 271</a></p>
      <h4 class="d-inline-block mt-5">Ascess:</h4>
      <span class="d-inline-block count" data-id="1000000">1000</p>
    </div>
  </div>
    `);
  ...
  var endnum = $(".count").text();
  var count = 0;
  $(".count").text("0");
  function animationNum(count) {
    $(".count").html(count);
    console.log($(".count").text());
    if (count < endnum) {
      setTimeout(() => {animationNum(count + 1)}, 0.001);
